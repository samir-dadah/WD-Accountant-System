...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"> التسليمات</h1>
    </div>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">جميع التسليمات</h6>
        </div>
        <div class="card-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                                    <h3 class="panel-title">قائمة التسليمات</h3>
                                </div>
                        ...
                        <div class="panel-body">
                            <div class="col-sm-12 table-responsive">
                                <table id="delivery_data" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th> ID</th>
                                            <th>اسم الشركة</th>
        ...
        <form method="post" id="delivery_form">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-plus"></i> انشاء ملف تسليم جديد</h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>اضف المنتجات الى التسليم</label>
                                <hr />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label> كلمة المرور حماية ملف التسليم</label>
...
<script>
    $(document).ready(function() {
        ...
        $('#add_button').click(function() {
            ...
            $('#delivery_form').parsley().reset();
            $('#comment').summernote('code', '');
            $('#customer_id').selectpicker("val", 0);
            $('#order_id').selectpicker("val", 0);
            $('.modal-title').html("<i class='fa fa-plus'></i> اضافة ملف تسليم  جديد  ");
        ...
        $('#delivery_form').parsley();
        $('#delivery_form').on('submit', function(e) {
            e.preventDefault();

            if ($('#delivery_form').parsley().validate()) {
            ...
            if (delivery_id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#delivery_form').parsley().reset();
                        $('#comment').summernote('code', '');
                        $('.modal-title').html("<i class='fa fa-edit'></i> تعديل  ملف تسليم فاتورة ");
                        $('#btn_submit').val('تعديل');
                        $('#action').val('edit_delivery');
            ...
            if (order_id) {
                $.ajax({
                    ...
                    success: function(data) {
                        console.log(data);
                        $('#customer_id').selectpicker("val", data.customer_id);
                        $('#delivery_date').val(data.invoice_date);
                        $('#span_product_details').html(data.product_details);
                        count = data.count + 1;
                    }
                });
