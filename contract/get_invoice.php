...
<body>
    ...
    <header>
        ...
        <table>
            <tr>
                <td style="width: 60%;">
                    <p style="font-size:26px;font-weight:700;padding-top:24px;"><?php echo get_l('INVOICE_NUMBER') . ' : ' .$data['invoice_data']['invoice_prfex'].' '. $data['invoice_data']['invoice_no'] . ' - ' . date('y', strtotime($data['invoice_data']['invoice_date'])); ?></p>
                </td>
                <td style="width: 40%;padding-left:42.5px;padding-top:3px;line-height:1.5;">
                    <div style="display: inline-block;margin:0 auto;">
                        ...
                        <?php echo get_l('INVOICE_DATE_TEXT') . ' : ' . date('d.m.Y', strtotime($data['invoice_data']['invoice_date'])); ?>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <main>
        ...
        <table>
            ...
            <tr>
                ...
                <td style="text-align: right;padding-right:45px;">
                    <?php echo price_format($data['invoice_data']['shipping_cost']) . '  ' . $data['ccsympol'] ?>
                </td>
            </tr>
            <tr>
                <td></td>
                ...
                <td style="text-align: right;padding-right:45px;">
                    <?php echo price_format($data['invoice_data']['first_payment']) . '  ' . $data['ccsympol'] ?>
                </td>
            </tr>
            <tr>
                <td></td>
                ...
                <td style="text-align: right;padding-right:45px;">
                    <?php echo price_format($data['invoice_data']['discount_total']) . '  ' . $data['ccsympol'] ?>
                </td>
            </tr>
            <tr>
                <td></td>
                ...
                <td style="text-align: right;padding-right:45px;">
                    ...
                    $total = $total - $data['invoice_data']['discount_total'];
                    $total = $total + $data['invoice_data']['shipping_cost'];
                    $total = $total - $data['invoice_data']['first_payment'];
            ...
            <tr>
                <td colspan="4" style="text-align: left;font-size:12px;">    
                    <p><?php echo get_l('TEXT_INVOICE_BOTTOM_TEXT'); ?></p>
                </td>
            </tr>
        </table>
    </main>
